                            ...
                            <div class="form-group">
                                ...
                                <select name="pharmacy" id="pharmacy" class="form-control">
                                    ...
                                    @foreach ($pharmacies as $pharmacy)
                                        <option value="{{ $pharmacy->id }}" {{ $doctor->pharmacy->id == $pharmacy->id ? 'selected' : '' }}>{{ $pharmacy->name }}</option>
                                    @endforeach
                                </select>
                                @error('pharmacy')
                            ...
                            <div class="form-group">
                                ...
                                <select name="user" id="user" class="form-control">
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ $doctor->user->id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                                @error('user')
                                    <span class="text-danger w-100">{{ $message }}</span>
