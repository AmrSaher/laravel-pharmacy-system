        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 d-flex" style="gap: 10px; justify-content: flex-end;">
                    <a href="/admin/export/permissions" class="btn btn-dark">Download excel file</a>
                    ...
                    <tr>
                        ...
                        <td style="display: flex; flex-wrap: wrap; gap: 10px;">
                            ...
                            <form method="POST"
                                  ...
                                  id="delete-permission-form-{{ $permission->id }}" style="display: none;">
                                @csrf
                                @method('delete')
                            </form>
                            <a href="#" class="btn btn-danger"
                               onclick="if (confirm('Are you sure ?')) document.getElementById('delete-permission-form-{{ $permission->id }}').submit()">
