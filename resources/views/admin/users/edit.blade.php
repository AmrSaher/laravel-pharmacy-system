                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="national_id" class="form-control" id="national_id"
                                        placeholder="Enter user national id" value="{{ $user->national_id }}" />
                                    @error('national_id')
                                        <span class="text-danger w-100">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_of_birth" class="form-control" id="date_of_birth"
                                        placeholder="Enter user birth" value="{{ $user->date_of_birth }}" />
                                </div>
                                <div class="form-group">
                                    <label for="mobile_number">Mobile number</label>
                                    <input type="number" name="mobile_number" class="form-control" id="mobile_number"
                                        placeholder="Enter user mobile number" value="{{ $user->mobile_number }}" />
                                    @error('mobile_number')
                                        <span class="text-danger w-100">{{ $message }}</span>
                                    @enderror
                                </div>
